...
<#
.SYNOPSIS
    Build the AirportCEO Tweaks solution or specific projects in Debug configuration.
...
.EXAMPLE
    ./build.ps1 -Project AirportCEOAircraft
    Builds only the AirportCEOAircraft project in Debug configuration.
...
Write-Host "Building MapScaleCeo (Debug)" -ForegroundColor Cyan
Write-Host "==================================================" -ForegroundColor Cyan
Write-Host ""
